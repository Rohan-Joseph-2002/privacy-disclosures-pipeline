"""
AUTHOR: Rohan Joseph
PURPOSE: Execute Stage 2 iOS privacy-label preparation.
...
from pipelines.prepare_ios_privacy_labels import run_prepare_ios_privacy_labels  # type: ignore
...
def run_stage() -> None:
    ...
    run_prepare_ios_privacy_labels(config = config, paths = paths)
...
if __name__ == "__main__":
    log_path = capture_script_console_to_markdown(
        ...
        script_name = "002_prepare_ios_privacy_labels",
