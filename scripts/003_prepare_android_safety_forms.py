"""
AUTHOR: Rohan Joseph
PURPOSE: Execute Stage 3 Android safety-form preparation.
...
from pipelines.prepare_android_safety_forms import run_prepare_android_safety_forms  # type: ignore
...
def run_stage() -> None:
    ...
    run_prepare_android_safety_forms(config = config, paths = paths)
...
if __name__ == "__main__":
    log_path = capture_script_console_to_markdown(
        ...
        script_name = "003_prepare_android_safety_forms",
