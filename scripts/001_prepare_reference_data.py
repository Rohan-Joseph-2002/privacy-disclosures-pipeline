"""
AUTHOR: Rohan Joseph
PURPOSE: Execute Stage 1 reference-data preparation.
...
from pipelines.prepare_reference_data import run_prepare_reference_data  # type: ignore
...
def run_stage() -> None:
    ...
    run_prepare_reference_data(config = config, paths = paths)
...
if __name__ == "__main__":
    log_path = capture_script_console_to_markdown(
        ...
        script_name = "001_prepare_reference_data",
